        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20 mt-5 font-bold leading-wider">
              おかえりなさい！
              </p>
            </div>
          </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-black dark:text-white font-bold">
                  メールアドレス
                  </label>
                ...
                <div className="mb-5">
                  <div onClick={clickRegister}      
                    className="w-full cursor-pointer rounded-lg border border-bg-meta-3 bg-meta-3 p-4 text-white transition hover:bg-opacity-90 text-center">
                    アカウントを新規作成
                  </div>
                </div>
